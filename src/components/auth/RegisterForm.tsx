...
import { demoLoginAction, registerAction, startGoogleOAuth } from "@/actions/auth";
  ...
  return (
    <Card className="mx-auto w-full max-w-md">
      <CardHeader className="space-y-1">
        ...
        <CardDescription>
          Register with email or Google — you’ll name your workspace next.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-5">
        <form action={formAction} className="space-y-4">
          <input type="hidden" name="oauth_return_path" value="/register" />
